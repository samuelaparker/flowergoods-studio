  ...
  return (
    <>
      <div className="relative text-2xl font-thin max-w-screen-xl mx-auto my-20">
        <div className="w-36 absolute left-0 top-0 flex items-end opacity-0 hover:opacity-100 duration-700 ease-in-out">
          <Image src={redFlower} alt="red flower decoration" />
          <div className="mx-[-20px]">flowers!</div>
        </div>
        <div className="flex items-center w-36 absolute top-0 right-0 opacity-0 hover:opacity-100 duration-700 ease-in-out">
          <div className="[text-wrap:nowrap] pt-4 mr-[-8px]">
            special events
          </div>
          <Image src={greenFlower} alt="green flower decoration" />
        </div>
        <div className="w-36 absolute bottom-0 left-0 flex items-end opacity-0 hover:opacity-100 duration-700 ease-in-out">
          <Image src={purpleFlower} alt="purple flower decoration" />
          <div className="[text-wrap:nowrap]">merch u want to wear!</div>
        </div>
        <div className="flex items-center w-52 absolute bottom-0 right-0 opacity-0 hover:opacity-100 duration-700 ease-in-out">
          <div>
