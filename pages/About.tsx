    ...
    <Layout pageTitle="About">
      <div className="h-screen">
        <div className="max-w-4xl mx-auto py-8 px-8 sm:px-6 lg:px-8 ">
          ...
          <div className="lg:text-2xl text-lg font-light">
            <p>
              Hey there, welcome to flowergoods.studio! flowergoods.studio is
              run by Trish Ramirez-Parker. We&apos;re all about bringing a touch
              of beauty + happy brain chemicals to your life through florals and
              floral goods.
            </p>
            <p className="mt-4">
              Our signature concept, saturday flowers, is inspired by our
              personal practice of rest + stillness. Every saturday, we deliver
              fresh blooms to your doorstep, so you can enjoy them over a cup of
              coffee or tea. It&apos;s a lovely way to add a touch of beauty to
              your weekend.
            </p>
            <p className="mt-4">
              We also offer one of a kind vases, floral arrangements + design
              for all kinds of occasions, from weddings to corporate events and
